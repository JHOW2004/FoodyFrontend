...
export const ProductManagerModal: React.FC<ProductManagerModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs overflow-y-auto">
      <div className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-3xl p-6 sm:p-8 w-full max-w-3xl shadow-2xl relative my-8">
        {/* Botão Fechar */}
        <button
          type="button"
          onClick={onClose}
        ...
        {isFormOpen ? (
          <form onSubmit={handleSubmit(onSubmit)} className="p-5 rounded-2xl bg-[var(--bg-main)] border border-[var(--border-color)] space-y-4 mb-6">
        ...
        <div className="space-y-4">
          ...
          {isLoading ? (
            ...
            <div className="max-h-80 overflow-y-auto pr-1 space-y-2.5 divide-y divide-[var(--border-color)]/40">
